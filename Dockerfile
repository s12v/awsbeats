...
RUN ls vendor/github.com
RUN rm -rf vendor/github.com/elastic
...
# See https://github.com/elastic/beats/commit/d21decb720e7fdeb986f4ebac413cc816353aa55
...
COPY --from=awsbeats /go/src/github.com/s12v/awsbeats/target/${BEAT_NAME}-${BEATS_VERSION}-go${GO_VERSION}-linux-amd64 /usr/share/${BEAT_NAME}/${BEAT_NAME}
